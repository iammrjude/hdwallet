pragma solidity >=0.4.22 <0.8.0; // pragma solidity ^0.5.0;
...
contract AmpleTokenSale is Crowdsale, CappedCrowdsale, TimedCrowdsale, AllowanceCrowdsale {
    uint public investorMinCap  = 2000000000000000; // 0.002 Ether
    uint public investorHardCap = 5000000000000000000; // 5 Ether
    mapping(address => uint256) private contributions; // private
    mapping(address => uint256) private _caps;
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        ...
        // solhint-disable-next-line max-line-length
        //require(_newContribution >= investorMinCap && _newContribution <= investorHardCap, "IndividuallyCappedCrowdsale: beneficiary's cap exceeded");
